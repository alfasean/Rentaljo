...
<head>
    <meta charset="utf-8">
    <title>Rentaljo | Sewa Motor</title>
                        ...
                        <div class="container">
                            <div class="row align-items-center justify-content-center justify-content-lg-start">
                                <div class="col-10 col-lg-7 text-center text-lg-start">
                                    <h1 class="display-3 text-white mb-4 pb-3 animated slideInDown">Sewa Motor Pertama di Kota Manado</h1>
                                    <a href="index.php?p=service" class="btn btn-primary py-3 px-5 animated slideInDown">Sewa Sekarang<i class="fa fa-arrow-right ms-3"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex align-items-center">
                        <div class="container">
                            <div class="row align-items-center justify-content-center justify-content-lg-start">
                                <div class="col-10 col-lg-7 text-center text-lg-start">
                                    <h1 class="display-3 text-white mb-4 pb-3 animated slideInDown">Jelajahi Kota Dengan Bebas dan Hemat</h1>
                                    <a href="index.php?p=service" class="btn btn-primary py-3 px-5 animated slideInDown">Sewa Sekarang<i class="fa fa-arrow-right ms-3"></i></a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item">
                        <div class="position-relative overflow-hidden">
                            <img class="img-fluid" src="img/alfa.jpeg" alt="">
                            <div class="team-overlay position-absolute start-0 top-0 w-100 h-100">
                            <a class="btn btn-square mx-1" href="https://www.linkedin.com/in/alfa-sean-kalapadang-lonteng-7a3902208/" target="_blank"><i class="fab fa-linkedin"></i></a>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item">
                        <div class="position-relative overflow-hidden">
                            <img class="img-fluid" src="img/jule.jpeg" alt="">
                            <div class="team-overlay position-absolute start-0 top-0 w-100 h-100">
                            <a class="btn btn-square mx-1" href="https://www.instagram.com/joulle.y/" target="_blank"><i class="fab fa-linkedin"></i></a>
                            <a class="btn btn-square mx-1" href="https://www.linkedin.com/in/juliansyahdaud/" target="_blank"><i class="fab fa-instagram"></i></a>
                            </div>
                        </div>
                        <div class="bg-light text-center p-4 dm">
