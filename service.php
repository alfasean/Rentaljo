...
<body>
  <!-- <nav class="navbar navbar-expand-lg bg-body-tertiary" style="background-color: #fff !important;">
    <div class="container">
      <a class="navbar-brand" href="#"> <img style="width: 90px; height: 90px;" src="img/logo1.png" alt="Logo"></a>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
          <li class="nav-item">
            <a class="nav-link active me-3" href="homepage_user.html">Home</a>
          </li>
          <li class="nav-item">
            <a class="nav-link me-3" href="#">Service</a>
          </li>
          <li class="nav-item">
